...
export type NavigationStateRoute<Params = NavigationParams> =
  NavigationLeafRoute<Params> & NavigationState;
...
export type NavigationAddListenerEventCallback =
  (eventName: NavigationEventType, callback: NavigationEventCallback) =>
    NavigationEventSubscription;

export type NavigationEmitEvent =
  (eventName: NavigationEventType, payload: NavigationEventPayload) => void;
