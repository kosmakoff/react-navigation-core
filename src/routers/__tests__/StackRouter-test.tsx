...
describe('StackRouter', () => {
  ...
  test('order of handling navigate action is correct for nested stackrouters', () => {
    ...
    const nestedRouter = StackRouter({
      Foo: Screen,
      Bar: Screen,
    });
    ...
    const activeState4 = state4.routes[state4.index];
    ...
    const activeState5 = state5.routes[state5.index];
  ...
  test('order of handling navigate action is correct for nested stackrouters 2', () => {
    ...
    const nestedRouter = StackRouter({ Foo: Screen, Bar: Screen });
    const otherNestedRouter = StackRouter({ Foo: Screen });
    NestedStack.router = nestedRouter;
