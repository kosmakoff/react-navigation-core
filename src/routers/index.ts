...
export type NavigationRouterActionCreatorsCallback<Actions = {}> =
  (state?: NavigationRoute | null, stateKey?: string | null) => Actions;

export interface NavigationRouterConfig<
  State,
  Options = NavigationScreenOptions,
  Params = NavigationParams,
  Actions = {}
> extends NavigationConfig<State, Options> {
...
export interface NavigationSwitchRouterConfig<
  ...
  Params = NavigationParams,
  Actions = {}
> extends NavigationRouterConfig<State, Options, Params, Actions> {
  order?: string[];
...
export interface NavigationTabRouterConfig<
  ...
  Params = NavigationParams,
  Actions = {}
> extends NavigationSwitchRouterConfig<State, Options, Params, Actions> {
  resetOnBlur?: boolean; // defaults to `false`
  // Does the back button cause the router to switch to the initial tab
  backBehavior?: 'none' | 'initialRoute'; // defaults `initialRoute`
};

export type NavigationSwitchRouterActionCreators = {};
...
export interface NavigationStackRouterActionCreators<Params = NavigationParams> {
  ...
  push: (routeName: string, params?: Params, action?: NavigationNavigateAction) =>
    NavigationPushAction;
  replace: (
    replaceWith: string,
    params?: Params,
