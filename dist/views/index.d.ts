...
import { NavigationScreenProp, NavigationComponentScreenProps, NavigationComponentProps } from '../screens';
...
export declare type NavigationEventsProps<State> = ViewProps & {
    navigation: NavigationScreenProp<State>;
} & {
