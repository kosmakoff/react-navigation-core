    ...
    class ComponentWithNavigation extends React.Component {
        render() {
            ...
            return (React.createElement(context_1.NavigationContext.Consumer, null, navigationContext => {
                ...
                utils_1.invariant(!!navigation, /* tslint:disable-next-line:max-line-length */ 'withNavigation can only be used on a view hierarchy of a navigator. The wrapped component is unable to get access to navigation from props or context.');
