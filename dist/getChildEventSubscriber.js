...
const events_1 = require("./views/events");
/*
...
function getChildEventSubscriber(addListener, key, initialLastFocusEvent = 'didBlur') {
    ...
    const emit = (type, payload) => {
        const payloadWithType = Object.assign({}, payload, { type });
    ...
    const upstreamSubscribers = events_1.NavigationEVENTNames.map(eventName => addListener(eventName, payload => {
