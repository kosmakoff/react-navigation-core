    ...
    class Navigator extends React.Component {
        ...
        static getDerivedStateFromProps(nextProps, prevState) {
            ...
            if (!navigation) { /* tslint:disable-next-line:max-line-length */
                invariant_1.default(false, 'The navigation prop is missing for this navigator. In react-navigation 3 you must set up your app container directly. More info: https://reactnavigation.org/docs/en/app-containers.html');
            }
            const { state } = navigation;
            const { routes } = state;
            if (typeof routes === undefined) { /* tslint:disable-next-line:max-line-length */
                invariant_1.default(false, 'No "routes" found in navigation state. Did you try to pass the navigation prop of a React component to a Navigator child? See https://reactnavigation.org/docs/en/custom-navigators.html#navigator-navigation-prop');
            }
            const descriptors = {};
